...
const dataExt = vscode.commands.registerCommand('magic-api', () => {
    ...
    vscode.window.showInputBox().then((value) => {
        ...
        axios_1.default.get(value).then((res) => {
...
const columnsExt = (context) => {
    return vscode.commands.registerCommand('magic-columns', () => {
        ...
        const web = vscode.window.createWebviewPanel('myWebview', // viewType
        'magic-columns', // 视图标题
        ...
        web.webview.onDidReceiveMessage((message) => {
            ...
            if (type === 'set-columns') {
                const startstr = '[\n';
                const endstr = ']\n';
                const objstr = columns.map((item, index) => {
...
const log_ext_1 = __webpack_require__(1);
const api_ext_1 = __webpack_require__(3);
const data_ext_1 = __webpack_require__(52);
const columns_ext_1 = __webpack_require__(53);
function activate(context) {
    context.subscriptions.push(log_ext_1.default);
    context.subscriptions.push(api_ext_1.default);
    context.subscriptions.push(data_ext_1.default);
    context.subscriptions.push((0, columns_ext_1.default)(context));
}
